...
def topology():
    ...
    e1 = net.addAccessPoint('e1', ssid='vanet-ssid',
                            mode='g', channel='1', position='3279.02,3736.27,0')
    e2 = net.addAccessPoint('e2', ssid='vanet-ssid',
                            mode='g', channel='6', position='2320.82,3565.75,0')
    e3 = net.addAccessPoint('e3', ssid='vanet-ssid', 
                            mode='g', channel='11', position='2806.42,3395.22,0')
    e4 = net.addAccessPoint('e4', ssid='vanet-ssid', 
                            mode='g', channel='1', position='3332.62,3253.92,0')
    e5 = net.addAccessPoint('e5', ssid='vanet-ssid',
                            mode='g', channel='6', position='2887.62,2935.61,0')
